  ...
  return (
    ...
    >
      <Suspense fallback={null}>
        <ambientLight intensity={1.0} color="#f8f0e0" />
        <directionalLight position={[5, 8, 5]} intensity={1.4} color="#fff8e8" />
        <directionalLight position={[-4, 2, -3]} intensity={0.5} color="#c8d8f0" />
        <pointLight position={[0, 3, 2]} intensity={0.35} color="#ffe0c0" />
